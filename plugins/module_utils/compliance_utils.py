...
XCU_REQUIRED_COMMANDS = frozenset(
    {"sh"} | XCU_SPECIAL_BUILTINS | XCU_RESERVED_WORDS | XCU_REQUIRED_UTILITIES
)
...
def process_all_compliance_command_results(
    ...
    _borrow_evidence(compliance["posix"], compliance["xsh"], compliance["xcu"])
    ...
    _borrow_evidence(compliance["sus"], compliance["posix"], compliance["xsi"])
    ...
    facts: dict[str, Any] = {
        ...
        "o0_shells": compose_shells(
            ...
            builtins_evidence=compose_evidence(commands=[LOOKUP_COMMAND]),
        ),
    }
