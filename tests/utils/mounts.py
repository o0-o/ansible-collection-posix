...
def assert_mount_has_fields(
    ...
    :param optional_fields: List of fields that may or may not be
                            present
...
def convert_dict_mounts_to_list(
    ...
    mounts were keyed by mount point to the new format where mounts
    are a list with a 'target' field.
